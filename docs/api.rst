...
Setup
-----
If you want to replay the actions of a script generated by "pywinauto_recorder.exe_" in your Python interpreter you must install the pywinauto_recorder_ package:
